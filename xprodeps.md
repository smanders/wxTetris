# wxTetris dependencies

|project|license [^_l]|description [dependencies]|version|source|diff [^_d]|
|-------|-------------|--------------------------|-------|------|----------|
|<a id='wxtetris' />[wxtetris](https://github.com/smanders/wxTetris)|[MIT](https://github.com/smanders/wxTetris/blob/dev/LICENSE 'MIT License')|wxWidgets Tetris game [pvt deps: _wxwidgets_]| | |  [intro]|
